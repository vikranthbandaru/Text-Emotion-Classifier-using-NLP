...
def create_emotionclf_table():
    c.execute('CREATE TABLE IF NOT EXISTS emotionclfTable(raw text TEXT,prediction TEXT,probability NUMBER,timeOfvisit TIMESTAMP)')    
...
def view_all_prediction_details():
    c.execute('SELECT * FROM emotioncfTable') 
    data = c.fetchall()
    return data       
